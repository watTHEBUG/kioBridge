      ...
      */}
      <div style={{ width: "100%", maxWidth: FRAME_W, height: FRAME_H }}>
        ...
        */}
        ...
        {/*
          연동 표시줄. **틀 안, 화면 아래 칸**이다.

          예전에는 틀 바깥에 position: fixed 로 띄웠는데, 그 상태로는 화면
          아래쪽 띠에 있는 것을 전부 가로챘다(Demo.tsx 의 스타일 주석에 잰 값이
          있다). 여기 두면 flex 가 자리를 잡아 주므로 아무것도 안 가린다.

          inert 를 씌운 칸 **밖**에 둔다 — 개인정보 겹이 떠 있어도 무엇이 오갔는지는
          계속 보여야 한다. 나란히 보는 중에는 감춘다. 같은 것을 두 번 띄울 이유가 없다.
        */}
        {팀백엔드모드 && 로그모드 !== "나란히" && (
